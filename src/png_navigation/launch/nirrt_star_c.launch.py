...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            executable='nirrt_star_node.py',
            name='nirrt_star_node',
            output='screen',
        ),
        Node(
            package='png_navigation',
            executable='nirrt_star_c_neural_wrapper_node.py',
            name='nirrt_star_c_neural_wrapper_node',
            output='screen',
        ),
        Node(
            package='png_navigation',
        ...
        Node(
            ...
            output='screen',
            arguments=['--use_neural_wrapper', '--map', LaunchConfiguration('map')],
        ),
    ])
